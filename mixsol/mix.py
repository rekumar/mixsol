...
class Weigher:
    ...
    def weights_to_solution(
        self, weights: dict, volume: float, solvent: str, norm=None, molarity=None
    ) -> Solution:
        ...
        Args:
            ...
            molarity (float, optional): As an alternative to the "norm" parameter, you can force the molarity to be this value. This will override norm!
        Returns:
